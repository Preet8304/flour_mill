...
import 'package:flour_mill/model/flour_mills.dart';
import 'package:flour_mill/service/flour_mill_service.dart';

class FlourMillData {
  static Future<List<FlourMill>> getFlourMills() async {
    FlourMillService service = FlourMillService();
    return await service.getFlourMills();
  }
}